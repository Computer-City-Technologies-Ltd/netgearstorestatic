...
useSeoMeta({
  title: "Netgear Store Bangladesh | Official Routers, Orbi Mesh & Switches",
  description:
  ...
  ogTitle: "Netgear Store Bangladesh",
  ogDescription:
    "Shop genuine Netgear routers, Orbi Mesh systems, and Nighthawk gaming routers at the best prices in Bangladesh. Official warranty, expert support, and fast delivery in Dhaka & across BD.",
  ogType: "website",
  ...
  twitterTitle:
    "Netgear Store Bangladesh | Official Routers, Orbi Mesh & Switches",
  twitterDescription:
    "Shop genuine Netgear routers, Orbi Mesh systems, and Nighthawk gaming routers at the best prices in Bangladesh. Official warranty, expert support, and fast delivery in Dhaka & across BD.",
  twitterImage: "/assets/images/cover.jpg",
});
</script>
<template>
  <Navbar />
