    ...
    <div class="container px-5 py-18 mx-auto">
      ...
      <div class="flex flex-wrap">
        <div class="py-4 flex flex-col items-start">
          <span
            class="inline-block py-1 px-0 mt-8 rounded bg-indigo-50 text-gray-900 text-4xl font-medium"
        ...
        <div class="py-4 flex flex-col items-start">
          ...
          <div class="leading-relaxed mt-2">
            <p class="leading-relaxed">
              ...
              presentation or appearance of our Website. <br />
              <br />
              ...
              bound to and follow these linking terms and conditions. <br />
              <br />
              ...
              on the website is kept up to date. <br />
              <br />
              Disclaimer <br />
              <br />
